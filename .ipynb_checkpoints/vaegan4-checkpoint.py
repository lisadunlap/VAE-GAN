...
class VAE(nn.Module):
    def __init__(self):
        ...
        #a = torch.randn(80, 12688, 1)
        #self.fc1 = nn.Conv1d(12648, 800, 1)
        #self.fc21 = nn.Conv1d(800, 80, 1)
        #self.fc22 = nn.Conv1d(800, 80, 1)
        #self.fc3 = nn.Conv1d(80, 800, 1)
...
class Aux(nn.Module):
    def __init__(self):
        ...
        self.fc3 = nn.Linear(1663,2000)
        self.fc4 = nn.Linear(2000, 11025)
        #self.fc5 = nn.Linear(400,200)
        #self.fc6 = nn.Linear(200,11025)
        self.relu = nn.ReLU()
        self.sigmoid = nn.Sigmoid()
    ...
    def decode(self,z, y, label, alpha):
        ...
        #ret2 = self.relu(self.fc5(ret))
        #ret3 = self.sigmoid(self.fc6(ret2))
